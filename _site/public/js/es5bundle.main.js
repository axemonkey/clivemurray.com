(function () {
	...
	const writeStyleOfTheMonth = thisMonth => {
	  ...
	  document.querySelector('#style-of-the-month').href = "/public/css/style-".concat(thisMonthData.month, ".css");
	  if (thisMonthData.credit) {
	    ...
	    unsplashLink.href = "https://unsplash.com/".concat(thisMonthData.credit.handle, "?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText");
